...
public class CommandResponseDto {
	...
	public CommandResponseDto(CommandRequestDto commandRequestDto) {
	...
	public CommandResponseDto(String workFlowId, String commandId, String commandName, String pluginId, String userId,
			String currentState) {
		super();
